...
Team and Enterprise administrators must first enable MCP access under **Admin → Security → Feature controls** in Lucid. Lucid MCP is not available for FedRAMP accounts.
